...
def main():
    # Read the logfile
    with open("build/log-heatup.txt", "r", encoding="UTF-8") as logfile:
    ...
    # Create x and y points for the plot
    ...
    plt.axhline(y=105, color='red', linestyle='--', linewidth=2) # setpoint line
    plt.xlabel('Time (s)')
